                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex">
                                        ...
                                        {/* <button
                                            ...
                                            disabled={sendingOtp}
                                            className="px-4 py-2 bg-gray-800 text-white rounded-r-lg hover:bg-black focus:outline-none focus:ring-2 focus:ring-gray-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                                        >
                                            {sendingOtp ? (
